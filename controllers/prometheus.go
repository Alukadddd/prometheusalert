	...
	for _, RMessage := range AlerMessage {
		...
		if nLevel == Messagelevel {
			if rphone == "" && RMessage.Annotations.Mobile == "" {
				...
				PostALYmessage(MobileMessage, phone,beego.AppConfig.String("ALY_DX_Template"), logsign)
				...
				if rphone != "" {
					...
					PostALYmessage(MobileMessage, rphone,beego.AppConfig.String("ALY_DX_Template"), logsign)
				...
				if RMessage.Annotations.Mobile != "" {
					...
					PostALYmessage(MobileMessage, RMessage.Annotations.Mobile,beego.AppConfig.String("ALY_DX_Template"), logsign)
