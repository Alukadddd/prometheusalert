...
func AddTpl(id int, tplname, t_type, t_use, tpl,tplCode ,tplParam string) error {
	o := orm.NewOrm()
	qs := o.QueryTable("PrometheusAlertDB")
...
func UpdateTpl(id int, tplname, t_type, t_use, tpl,tplCode,tplParam string) error {
	o := orm.NewOrm()
	...
	if err == nil {
		...
		tpl_update.Tpl = tpl
		tpl_update.TplCode = tplCode
		tpl_update.TplParam = tplParam
